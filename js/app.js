...
function multiplyArray(multArr) { //eslint-disable-line
  ...
  let string = `The numbers ${multArr} have a product of ${multiplyTwo}.`;

  return [multiplyTwo, string];
}
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
  ...
  for (let i = 0; i < dynamicArray.length; i++) {
    multiplyDyn = multiply(multiplyDyn, dynamicArray[i])[0];
  }

  let string = `The numbers ${dynamicArray} have a product of ${multiplyDyn}.`;

  return [multiplyDyn, string];
}
